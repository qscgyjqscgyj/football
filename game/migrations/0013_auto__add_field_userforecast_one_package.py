...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserForecast.one_package'
        db.add_column(u'game_userforecast', 'one_package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.UserPackage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserForecast.one_package'
        db.delete_column(u'game_userforecast', 'one_package_id')
    ...
    models = {
        ...
        u'game.userforecast': {
            ...
            'one_package': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['packages.UserPackage']", 'null': 'True', 'blank': 'True'}),
