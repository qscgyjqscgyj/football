...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserForecast.forecast'
        db.add_column(u'game_userforecast', 'forecast',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user_forecast_forecast', to=orm['game.Forecast']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserForecast.forecast'
        db.delete_column(u'game_userforecast', 'forecast_id')
