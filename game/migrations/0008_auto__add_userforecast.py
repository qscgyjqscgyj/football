...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserForecast'
        db.create_table(u'game_userforecast', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_forecast_user', to=orm['user_profile.CustomUser'])),
            ('supernumerary', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_forecast_supernumerary', to=orm['user_profile.Supernumerary'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_forecast_game', to=orm['game.Game'])),
        ))
        db.send_create_signal(u'game', ['UserForecast'])


    def backwards(self, orm):
        # Deleting model 'UserForecast'
        db.delete_table(u'game_userforecast')
    ...
    models = {
        ...
        u'game.userforecast': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_forecast_game'", 'to': u"orm['game.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
