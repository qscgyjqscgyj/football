...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'game_forecast', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('supernumerary', self.gf('django.db.models.fields.related.ForeignKey')(related_name='forecast_supernumerary', to=orm['user_profile.Supernumerary'])),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(related_name='forecast_game', to=orm['game.Game'])),
            ...
            ('win_team', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forecast_team', null=True, to=orm['game.Team'])),
        ))
        db.send_create_signal(u'game', ['Forecast'])


    def backwards(self, orm):
        # Deleting model 'Forecast'
        db.delete_table(u'game_forecast')
    ...
    models = {
        ...
        u'game.forecast': {
            ...
            'supernumerary': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forecast_supernumerary'", 'to': u"orm['user_profile.Supernumerary']"}),
