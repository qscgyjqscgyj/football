...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserForecast.game'
        db.delete_column(u'game_userforecast', 'game_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserForecast.game'
        raise RuntimeError("Cannot reverse this migration. 'UserForecast.game' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UserForecast.game'
        db.add_column(u'game_userforecast', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_forecast_game', to=orm['game.Game']),
                      keep_default=False)
