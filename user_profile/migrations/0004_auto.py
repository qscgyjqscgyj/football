...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users on 'Supernumerary'
        m2m_table_name = db.shorten_name(u'user_profile_supernumerary_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('supernumerary', models.ForeignKey(orm[u'user_profile.supernumerary'], null=False)),
            ('customuser', models.ForeignKey(orm[u'user_profile.customuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['supernumerary_id', 'customuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'Supernumerary'
        db.delete_table(db.shorten_name(u'user_profile_supernumerary_users'))
