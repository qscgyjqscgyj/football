...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field packages on 'CustomUser'
        m2m_table_name = db.shorten_name(u'user_profile_customuser_packages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'user_profile.customuser'], null=False)),
            ('userpackage', models.ForeignKey(orm[u'packages.userpackage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['customuser_id', 'userpackage_id'])


    def backwards(self, orm):
        # Removing M2M table for field packages on 'CustomUser'
        db.delete_table(db.shorten_name(u'user_profile_customuser_packages'))
