...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'user_profile_customuser', 'photo')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomUser.photo'
        raise RuntimeError("Cannot reverse this migration. 'CustomUser.photo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomUser.photo'
        db.add_column(u'user_profile_customuser', 'photo',
