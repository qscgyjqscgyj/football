...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'user_profile_customuser', (
        ...
        db.send_create_signal(u'user_profile', ['CustomUser'])

        # Adding model 'Supernumerary'
        db.create_table(u'user_profile_supernumerary', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('fio', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ...
        db.send_create_signal(u'user_profile', ['Supernumerary'])


    def backwards(self, orm):
        # Deleting model 'CustomUser'
        db.delete_table(u'user_profile_customuser')

        # Deleting model 'Supernumerary'
        db.delete_table(u'user_profile_supernumerary')
