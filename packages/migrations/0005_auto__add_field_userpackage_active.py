...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPackage.active'
        db.add_column(u'packages_userpackage', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPackage.active'
        db.delete_column(u'packages_userpackage', 'active')
