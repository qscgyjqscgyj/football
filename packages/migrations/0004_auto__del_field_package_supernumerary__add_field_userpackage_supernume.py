...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Package.supernumerary'
        db.delete_column(u'packages_package', 'supernumerary_id')

        # Adding field 'UserPackage.supernumerary'
        db.add_column(u'packages_userpackage', 'supernumerary',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_package_supernumerary', null=True, to=orm['user_profile.Supernumerary']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Package.supernumerary'
        db.add_column(u'packages_package', 'supernumerary',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='package_supernumerary', null=True, to=orm['user_profile.Supernumerary'], blank=True),
                      keep_default=False)

        # Deleting field 'UserPackage.supernumerary'
        db.delete_column(u'packages_userpackage', 'supernumerary_id')
