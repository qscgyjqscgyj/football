...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.supernumerary'
        db.alter_column(u'packages_package', 'supernumerary_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['user_profile.Supernumerary']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Package.supernumerary'
        raise RuntimeError("Cannot reverse this migration. 'Package.supernumerary' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Package.supernumerary'
        db.alter_column(u'packages_package', 'supernumerary_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.Supernumerary']))
    ...
    models = {
        ...
        u'packages.package': {
            ...
            'supernumerary': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'package_supernumerary'", 'null': 'True', 'to': u"orm['user_profile.Supernumerary']"})
        },
