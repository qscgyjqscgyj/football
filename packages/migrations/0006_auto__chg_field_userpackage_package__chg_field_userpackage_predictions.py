...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPackage.package'
        db.alter_column(u'packages_userpackage', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['packages.Package']))

        # Changing field 'UserPackage.predictions'
        db.alter_column(u'packages_userpackage', 'predictions', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserPackage.package'
        raise RuntimeError("Cannot reverse this migration. 'UserPackage.package' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserPackage.package'
        db.alter_column(u'packages_userpackage', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['packages.Package']))

        # User chose to not deal with backwards NULL issues for 'UserPackage.predictions'
        raise RuntimeError("Cannot reverse this migration. 'UserPackage.predictions' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserPackage.predictions'
        db.alter_column(u'packages_userpackage', 'predictions', self.gf('django.db.models.fields.IntegerField')())
